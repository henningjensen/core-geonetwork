...
GeoNetwork.Templates.GEONORGE = new Ext.XTemplate(
		...
		'<thead><tr>',
		'<th></th><th>Tittel</th><th>Organisasjon</th><th>Ressurstype</th><th>Lenker</th><th>Produktinformasjon</th>',
		'</tr></thead><tbody>',
		'<tpl for=".">',
		'<tr class="md md-full md-geonorge" style="{featurecolorCSS}"',
		'<tpl if="values.abstract">',
			' title="{[values.abstract.substring(0, 350)]}"',
		'</tpl>',
		'>',
          ...
          '<td>',
            '<div class="md-links">',
            	...
            	'<tpl for="links">',
	                ...
	                '</tpl>',
	                '<tpl if="parent.dynamic==\'true\' && values.type == \'application/vnd.google-earth.kml+xml\'">',
	                    '<li><a href="{href}" class="md-mn md-mn-kml" alt="Open kml">Åpne (KML)&nbsp;</a></li>',
	                '</tpl>',
	                '<tpl if="parent.download==\'true\' && (values.type == \'application/zip\' || values.type == \'application/x-compressed\')">',
	      ...
	      '<td class="md-links">',
	      	...
	      	'<tpl if="produktspesifikasjon">',
	      		'<li><a href="{produktspesifikasjon}"  target="_blank" class="md-mn md-mn-zip" alt="Last ned produktspesifikasjon">Last ned produktspesifikasjon&nbsp;</a></li>',
	      	'</tpl>',
	      	'<tpl if="produktark">',
	      		'<li><a href="{produktark}" target="_blank" class="md-mn md-mn-zip" alt="Last ned produktark">Last ned produktark&nbsp;</a></li>',
	      	'</tpl>',
	      	'<tpl if="tegnforklaring">',
	      		'<li><a href="{tegnforklaring}" target="_blank" class="md-mn md-mn-zip" alt="Last ned tegnforklaring">Last ned tegnforklaring&nbsp;</a></li>',
	      	'</tpl>',
	      	'<tpl if="produktside">',
	      		'<li><a href="{produktside}" target="_blank" class="md-mn md-mn-www" alt="Gå til produktside">Gå til produktside&nbsp;</a></li>',
	      	'</tpl>',
	      	'</ul>',
	      '</td>',
		'</tr>',
